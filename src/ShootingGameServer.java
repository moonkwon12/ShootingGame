...
class MapInstance {
    ...
    private String obstacleImagePath; // 장애물 이미지 경로
        ...
        try {
            ...
            if (player != null) {
                ...
                if (map != null) {
                    ...
                    // 게임이 종료되지 않은 상태에서만 승리 메시지 전송
                    if (!map.isGameOver() && !map.getPlayers().isEmpty()) {
